...
<a href="./publications/references.bib" target="_blank" class="button-text">Bibtex (all references)</a>
...
with open("./publications/publications.yaml") as f:
...
for year in items_by_year:
  ...
  for item in year_items:
    ...
    root_url = path.join('.', 'publications', item['root'])
