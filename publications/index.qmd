...
<a href="./references.bib" target="_blank" class="button-text">Bibtex (all references)</a>
...
for year in items_by_year:
  ...
  for item in year_items:
    ...
    if item['links'] is not None:
      ext_links = [f"<a href='{ext['href']}' target='_blank' class='button-text'>{ext['name']}</a>" for ext in item['links']]
      item_output += '&nbsp;&nbsp;' + '&nbsp;&nbsp;'.join(ext_links)
    item_output += '</li>'
    item_output += '</ul>'
    item_output += '</li>'
